...
当前可玩的卡池包含奥术师、守卫、猎人、工匠、灵魂使五个职业与中立卡。灵魂使以亡灵留场、死亡契约、主动牺牲和治疗转伤害为主要玩法。当前版本为 **1.1.1-pre-release**，卡池与规则仍在迭代，平衡性仍需实战检验。
...
| 客户端各功能与界面操作、存档位置 | [客户端功能与操作](Docs/GameplayGuide.zh-CN.md) |

...
| [客户端功能与操作](../GameplayGuide.zh-CN.md) | 大厅九页、开局方式、对战协议、牌组工坊与存档位置 |
| [生成卡表](../CardTable.zh-CN.md) | 五职业共 282 张卡的名称、说明与数值 |

规则取舍和确定性约束见 [ADR 索引](../ADR/README.md)。卡池与平衡仍在迭代，当前定义和数量以 [生成卡表](../CardTable.zh-CN.md) 与源文件 `Content/Source/Cards` 为准。
